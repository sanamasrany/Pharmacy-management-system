class PharmacyMedicineHomeOnePage {
  List<PharmacyMedicines>? pharmacyMedicines;

  PharmacyMedicineHomeOnePage({this.pharmacyMedicines});

  PharmacyMedicineHomeOnePage.fromJson(Map<String, dynamic> json) {
    if (json['pharmacyMedicines'] != null) {
      pharmacyMedicines = <PharmacyMedicines>[];
      json['pharmacyMedicines'].forEach((v) {
        pharmacyMedicines!.add(new PharmacyMedicines.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.pharmacyMedicines != null) {
      data['pharmacyMedicines'] =
          this.pharmacyMedicines!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class PharmacyMedicines {
  ...
  PharmacyMedicines.fromJson(Map<String, dynamic> json) {
    id = json['id'];
